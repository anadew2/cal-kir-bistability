...
gCaLs_range_KirCaLs = range(0.,stop=0.5,length=21)
gKir_range_KirCaLs = range(0.,stop=1.,length=11)
gCaLs_range_KMCaLs = range(0.,stop=0.5,length=21)
...
m_IX_CaLs = (IX_KirCaLs_1_end-IX_KirCaLs_1_1)/gCaLs_range_KirCaLs[end]

IX_CaLs = IX_KirCaLs_1_1 .+ m_IX_CaLs .*gCaLs_range_KirCaLs
IX_KirCaLs = []
for ix in IX_CaLs
...
m_IX_CaLs = (IX_KMCaLs_1_end-IX_KMCaLs_1_1)/gCaLs_range_KMCaLs[end]

IX_CaLs = IX_KMCaLs_1_1 .+ m_IX_CaLs .*gCaLs_range_KMCaLs
IX_KMCaLs = []
for ix in IX_CaLs
    IX = ix .+ m_IX_KM .*0. .*gKM_range_KMCaLs .-12
    push!(IX_KMCaLs,IX)
end