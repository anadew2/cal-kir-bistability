...
### SCRIPT INPUTS ###
    ...
    i_batch_gKM_range_KMCaLs = 1arse(Int64, ARGS[2])      #1:n_batch_gKM_range_KMCaLs:length(gKM_range_KMCaLs)
...
### INPUTS ###
    ...
    jld_name = "data/jld/dI_KMCaLs_m2_"
...
### TASK ###
    ...
    for i_gKM_range_KMCaLs in batch_gKM_range_KMCaLs
        ...
        p_var_i_batch = [I,gNa,gKDR,gKir,gKM_range_KMCaLs[i_gKM_range_KMCaLs],pCaLs_range_KMCaLs[i_pCaLs_range_KMCaLs],0.,gleak]
