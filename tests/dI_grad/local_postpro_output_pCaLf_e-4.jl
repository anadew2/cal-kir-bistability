...
function load_dI_mat(jld_name)
    ...
    jld_name = "ChannelUpdate/cluster/dI_grad/data/jld_pCaLf_1.5e-4/dI_KirCaLs_pCaLf_1.5e-5"
    #==
    ...
    dI_KirCaLs_pCaLf_15e_4,I1_KirCaLs_pCaLf_15e_4,I2_KirCaLs_pCaLf_15e_4,VSN_KirCaLs_pCaLf_15e_4 = load_dI_mat(string(jld_name,"_1e-2_1e-5.jld"))
    plt = Plots.heatmap(gKir_range_KirCaLs[1:3:end],pCaLs_range_KirCaLs[1:2:end],dI_KirCaLs_pCaLf_15e_4,fill=true,levels=100,lw=0,c=:linear_wcmr_100_45_c42_n256)
    ...
    plt = Plots.heatmap(gKir_range_KirCaLs[1:3:end],pCaLs_range_KirCaLs[1:2:end],I1_KirCaLs_pCaLf_15e_4,fill=true,levels=100,lw=0,c=:linear_wcmr_100_45_c42_n256,clims=(-3.1,3.5))
    ...
    plt = Plots.heatmap(gKir_range_KirCaLs[1:3:end],pCaLs_range_KirCaLs[1:2:end],I2_KirCaLs_pCaLf_15e_4,fill=true,levels=100,lw=0,c=:linear_wcmr_100_45_c42_n256)
    ...
    jld_name = "ChannelUpdate/cluster/dI_grad/data/jld_pCaLf_1.5e-4/dI_KMCaLs_pCaLf_1.5e-5"
    #==
    # This block load the results from the separated jld files and combine them in a single jld 
    ...
    dI_KMCaLs_pCaLf_15e_4,I1_KMCaLs_pCaLf_15e_4,I2_KMCaLs_pCaLf_15e_4,VSN_KMCaLs_pCaLf_15e_4 = load_dI_mat(string(jld_name,"_1e-2_1e-5.jld"))
    plt = Plots.heatmap(gKM_range_KMCaLs[1:3:end],pCaLs_range_KMCaLs[1:2:end],dI_KMCaLs_pCaLf_15e_4,fill=true,levels=100,lw=0,c=:linear_wcmr_100_45_c42_n256,clims=(0,3.719))
    ...
    plt = Plots.heatmap(gKM_range_KMCaLs[1:3:end],pCaLs_range_KMCaLs[1:2:end],I1_KMCaLs_pCaLf_15e_4,fill=true,levels=100,lw=0,c=:linear_wcmr_100_45_c42_n256,clims=(-3.1,6.3))
    ...
    plt = Plots.heatmap(gKM_range_KMCaLs[1:3:end],pCaLs_range_KMCaLs[1:2:end],I2_KMCaLs_pCaLf_15e_4,fill=true,levels=100,lw=0,c=:linear_wcmr_100_45_c42_n256)
