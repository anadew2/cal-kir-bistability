...
### TASK ###
    ...
    for i_gKir_range_KirCaLs in batch_gKir_range_KirCaLs
        jld_name_i = string(jld_name,"i_pCaLs_$(i_pCaLs_range_KirCaLs)_i_gKir_$(i_gKir_range_KirCaLs).jld")
        println("------------ Simulation for i_pCaLs = $(i_pCaLs_range_KirCaLs) & i_gKir = $(i_gKir_range_KirCaLs) ------------")
        p_var_i_batch = [I,gNa,gKDR,gKir_range_KirCaLs[i_gKir_range_KirCaLs],gKM,pCaLf,pCaLs_range_KirCaLs[i_pCaLs_range_KirCaLs],gleak]
        find_dI_ = find_dI([p_var_i_batch,p_fixed],ic,[],[],[],[gKir_range_KirCaLs[i_gKir_range_KirCaLs]],[],[IX_KirCaLs[i_pCaLs_range_KirCaLs][i_gKir_range_KirCaLs]])
