...
### TASK ###
    ...
    for i_gKM_range_KMCaLs in batch_gKM_range_KMCaLs
        jld_name_i = string(jld_name,"i_gCaLs_$(i_gCaLs_range_KMCaLs)_i_gKM_$(i_gKM_range_KMCaLs).jld")
        p_var_i_batch = [I,gNa,gKDR,gKir,gKM_range_KMCaLs[i_gKM_range_KMCaLs],gCaLf,gCaLs_range_KMCaLs[i_gCaLs_range_KMCaLs],gleak]
        find_dI_ = find_dI([p_var_i_batch,p_fixed],ic,[],[],[],[],[gKM_range_KMCaLs[i_gKM_range_KMCaLs]],[IX_KMCaLs[i_gCaLs_range_KMCaLs][i_gKM_range_KMCaLs]])
