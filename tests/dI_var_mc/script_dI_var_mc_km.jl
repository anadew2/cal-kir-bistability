...
### TASK ###
    ...
    for i_batch in batch_mc_var_mat
        ...
        p_var_i_batch = [I,gNa_var_mat[i_batch],gKDR,gKir_KMCaLs,gKM_KMCaLs,pCaLf,pCaLs_KMCaLs,gleak_var_mat[i_batch]]
        find_dI_ = find_dI([p_var_i_batch,p_fixed_i_batch],ic,[],[],[],[],[gKM_KMCaLs],[0])
