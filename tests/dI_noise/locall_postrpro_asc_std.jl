...
## Kir from stable state ##
    ...
    std_It_noise_kir_Ihalf_st,t_noise_kir_Ihalf_st,noisy_sol_cb_V_kir_Ihalf_st,noisy_sol_cb_t_kir_Ihalf_st = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_kir_Ihalf,"st.jld"))
...
## Kir from spiking state ##
    ...
    std_It_noise_kir_Ihalf_cyc,t_noise_kir_Ihalf_cyc,noisy_sol_cb_V_kir_Ihalf_cyc,noisy_sol_cb_t_kir_Ihalf_cyc = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_kir_Ihalf,"cyc.jld"))
...
## KM from stable state ##
    ...
    std_It_noise_km_Ihalf_st,t_noise_km_Ihalf_st,noisy_sol_cb_V_km_Ihalf_st,noisy_sol_cb_t_km_Ihalf_st = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_km_Ihalf,"st.jld"))
...
## KM from spiking state ##
    ...
    std_It_noise_km_Ihalf_cyc,t_noise_km_Ihalf_cyc,noisy_sol_cb_V_km_Ihalf_cyc,noisy_sol_cb_t_km_Ihalf_cyc = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_km_Ihalf,"cyc.jld"))
...
## Kir from stable state ##
    ...
    std_It_noise_kir_I1_st,t_noise_kir_I1_st,noisy_sol_cb_V_kir_I1_st,noisy_sol_cb_t_kir_I1_st = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_kir_I1,"st.jld"))
...
## Kir from spiking state ##
    ...
    std_It_noise_kir_I1_cyc,t_noise_kir_I1_cyc,noisy_sol_cb_V_kir_I1_cyc,noisy_sol_cb_t_kir_I1_cyc = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_kir_I1,"cyc.jld"))
...
## KM from stable state ##
    ...
    std_It_noise_km_I1_st,t_noise_km_I1_st,noisy_sol_cb_V_km_I1_st,noisy_sol_cb_t_km_I1_st = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_km_I1,"st.jld"))
...
## KM from spiking state ##
    ...
    std_It_noise_km_I1_cyc,t_noise_km_I1_cyc,noisy_sol_cb_V_km_I1_cyc,noisy_sol_cb_t_km_I1_cyc = load_asc_sim(string("ChannelUpdate/cluster/dI_noise/",jld_name_km_I1,"cyc.jld"))
