...
### INPUTS ###
    ...
    #jld_name = "data/asc_sim/asc_KirCaLs_10s"
    jld_name = "data/asc_sim/asc_KirCaLs_I1_10s_"

    #jld_name_f = "data/fig/asc_KirCaLs_10s"
    jld_name_f = "data/fig/asc_KirCaLs_I1_10s_"
...
## from stable state ##
    ...
    plot(t_noise_kir_st,std_It_noise_kir_st)
    plot(noisy_sol_cb_t_kir_st,noisy_sol_cb_V_kir_st)
...
## from spiking state ##
    ...
    plot(t_noise_kir_cyc,std_It_noise_kir_cyc)
    plot(noisy_sol_cb_t_kir_cyc,noisy_sol_cb_V_kir_cyc)
