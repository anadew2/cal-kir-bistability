...
function sim_noisy_pulse_cb(p,ic,state_i,tspan,nspan,I1bist,I2bist,f_eq)
    ...
    #savefig(plt_all,"test_km_st_switch_32.svg")
...
### INPUTS ###
    ...
    #jld_name = "data/jld/multi_switch_KMCaLs_N500_n25_"
    #jld_name = "data/jld/multi_switch_KMCaLs_I1_N500_n25_"
    jld_name = "data/jld/multi_switch_KMCaLs_cyc_N500_n25_"
    #jld_name = "data/jld/multi_switch_KMCaLs_cyc_I1_N500_n25_"
...
### TASK ###
    ...
    switchwithsigma_noise_i = switchwithstd_wsave([p_var,p_fixed],sigma_vec_,I1bist,I2bist,f_eq,ic_cyc,"cycle",tspan,nspan,n_samples,jld_name_i) 
