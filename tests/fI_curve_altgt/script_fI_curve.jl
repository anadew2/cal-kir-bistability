...
### SCRIPT INPUTS ###
    i_pCaLs_range_KirKMCaLs = parse(Int64, ARGS[1])     #1:length(pCaLs_range_KirKMCaLs_fI)
    i_gKir_range_KirKMCaLs = parse(Int64, ARGS[2])      #1:length(gKir_range_KirKMCaLs_fI)
    i_gKM_range_KirKMCaLs = parse(Int64, ARGS[3])       #1:length(gKM_range_KirKMCaLs_fI)
    i_batch = parse(Int64, ARGS[4])                   #1:n_batch
...
### INPUTS ###
    ...
    jld_name = "data/jld/fI_KirKMCaLs__"
